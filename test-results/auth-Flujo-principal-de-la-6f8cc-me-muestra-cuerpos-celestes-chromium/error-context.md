...
- Name: auth.spec.js >> Flujo principal de la app >> la home muestra cuerpos celestes
- Location: e2e\auth.spec.js:47:3
...
Locator: locator('.image-card').first()
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('.image-card').first()
...
- banner:
  ...
  - navigation:
    ...
    - link "Ingresar":
      - /url: /login
- main:
  - heading "Explorá el universo" [level=1]
  - paragraph: Descubrí imágenes del espacio, guardá tus favoritas y compartí comentarios.
```
